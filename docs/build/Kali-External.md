...
I installed Kali to a VM using the [NetInstaller ISO](https://cdimage.kali.org/kali-2025.3/kali-linux-2025.3-installer-netinst-amd64.iso) image, then installed Apache2 and VSFTP to serve as our exfiltration destinations.