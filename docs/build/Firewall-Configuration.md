...
The next part of this project is to configure the virtual machines to populate the network and conduct our tests. Return to the [project index](docs/index.md) page for information on those VMs.